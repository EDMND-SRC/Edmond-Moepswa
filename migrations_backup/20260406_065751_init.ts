...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_category" AS ENUM('web', 'automation', 'boilerplate', 'open-source', 'seo');
  CREATE TYPE "public"."enum_faqs_category" AS ENUM('general', 'services', 'process', 'pricing', 'technical');
  CREATE TYPE "public"."enum_leads_source" AS ENUM('contact', 'calculator', 'gumroad');
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_title" varchar DEFAULT 'Edmond Moepswa | Product Designer & Web Developer' NOT NULL,
  	"site_description" varchar NOT NULL,
  	"logo_id" integer,
  	"contact_email" varchar DEFAULT 'edmond.moepswa@gmail.com',
  	"contact_phone" varchar DEFAULT '+267 78 692 888',
  	"whatsapp_number" varchar DEFAULT '+267 78 692 888',
  	"social_links_linkedin" varchar,
  	"social_links_twitter" varchar,
  	"social_links_github" varchar,
  	"social_links_substack" varchar DEFAULT 'https://substack.com/@edmnd',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
