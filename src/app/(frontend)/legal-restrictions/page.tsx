...
export default function LegalRestrictionsPage() {
  return (
    <PolicyLayout title="Legal Restrictions & Disclaimers" lastUpdated="April 6, 2026">
      <p>
        ...
        update date. Please review them before we start working together.
      </p>
      ...
      <p>
        <strong>
          All payment, SMS, and communication platform integrations require the client to hold active accounts
        </strong>{' '}
        with the respective providers. I can guide you through the process, but I don&apos;t control the final approval or timelines set by the providers.
      </p>
