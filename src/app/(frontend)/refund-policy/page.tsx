...
export default function RefundPolicyPage() {
  return (
    <PolicyLayout title="Refund & Dispute Policy" lastUpdated="April 6, 2026">
      <h2>1. Overview</h2>
      <p>
        The following policy applies to all project engagements and digital products. 
        By engaging my services or purchasing from the store, you acknowledge and accept these terms.
      </p>
      ...
      <p>
        Digital products, including boilerplate starter kits and guides, are
