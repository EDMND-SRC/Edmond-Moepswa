      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          >
            ...
            <p>
              If you cancel a project and wish to re-engage later,{' '}
              <strong>you are welcome back</strong>. There is no penalty, no reinstatement fee, and
              no prejudice from the cancellation.
            </p>
            <p>
