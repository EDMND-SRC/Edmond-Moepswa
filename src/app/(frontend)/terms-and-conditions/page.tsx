        ...
        <FadeIn>
          ...
          >
            ...
            <p>
              ...
              available free tier first, and recommend a paid upgrade only when your needs genuinely
              require it. Where a paid tier is necessary, its cost is disclosed at scoping -- not
              after build.
            </p>
            ...
            <p>
              ...
              in every proposal.{' '}
              <strong>The delivery timeline clock pauses during client review periods.</strong>{' '}
              Delays caused by client feedback cycles, content provision, asset delivery, or
            ...
            <p>
              ...
              and WhatsApp Business API approval (Meta Business verification) are{' '}
              <strong>outside my control</strong> and are factored into timeline estimates as
            ...
            <p>
              <strong>Intellectual property transfers to the client upon full payment.</strong>{' '}
              Until the balance is settled in full, I retain ownership of all deliverables, source
            ...
            <p>
              All payment gateway integrations require the{' '}
              <strong>client to hold an active merchant account</strong> with the provider. Approval
              timelines and criteria vary by bank and provider and are outside my control.
            </p>

            <h2>12. WhatsApp Business API Disclaimer</h2>
            <p>
              WhatsApp Business API integration requires <strong>Meta Business verification</strong>
              . Approval typically takes 1-7 business days but is <strong>not guaranteed</strong>.
              Approval is at Meta&apos;s sole discretion and may be rejected for unverified business
              details, non-compliant use cases, or inconsistencies between submitted documents and
              Meta records.
            </p>
            <p>
              If verification is not obtained, the <strong>WhatsApp click-to-chat link</strong>{' '}
              (free in all builds) remains available as a simple alternative -- no API, no approval,
              no cost.
            </p>
