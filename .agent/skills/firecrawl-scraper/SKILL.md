...
# or pnpm add @mendable/firecrawl-js
# or use the unscoped package: npm install firecrawl
```
...
**Note**: The Node.js SDK requires Node.js >=22.0.0 and cannot run in Cloudflare Workers. Use direct REST API calls in Workers.
