...
Launch all 5 subagents simultaneously using Antigravity's Task tool. Each subagent receives the full discovery briefing. All subagents run with `subagent_type: "general-purpose"`.
