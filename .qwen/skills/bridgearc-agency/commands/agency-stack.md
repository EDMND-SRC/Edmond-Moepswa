...
```bash
test -f .agents/skills/bridgearc-agency/SKILL.md && echo "INSTALLED" || echo "MISSING"
test -f .agents/skills/bridgearc-agency/SKILL.md && echo "INSTALLED" || echo "MISSING"
test -f .agents/skills/bridgearc-agency/SKILL.md && echo "INSTALLED" || echo "MISSING"
test -f .agents/skills/bridgearc-agency/SKILL.md && echo "INSTALLED" || echo "MISSING"
test -f .agents/skills/bridgearc-agency/SKILL.md && echo "INSTALLED" || echo "MISSING"
...
|-------|------|--------|--------|-----------------|
| AI Marketing Suite | `.agents/skills/bridgearc-agency/SKILL.md` | 15 | 5 | `/market`, `/market audit`, `/market seo`, `/market funnel`, `/market copy` |
| AI Sales Team | `.agents/skills/bridgearc-agency/SKILL.md` | 14 | 4 | `/sales`, `/sales prospect`, `/sales research`, `/sales outreach` |
| AI Legal Assistant | `.agents/skills/bridgearc-agency/SKILL.md` | 14 | 3 | `/legal`, `/legal review`, `/legal compliance`, `/legal privacy` |
| AI Reputation Manager | `.agents/skills/bridgearc-agency/SKILL.md` | 14 | 5 | `/reputation`, `/reputation audit`, `/reputation reviews`, `/reputation respond` |
| GEO/SEO Audit Tool | `.agents/skills/bridgearc-agency/SKILL.md` | 11 | 5 | `/geo`, `/geo audit`, `/geo citability`, `/geo schema` |
...
================================================================
  ...
  COMMAND CENTER
  ----------------------------------------------------------------
  [checkmark] Agency Orchestrator     .agents/skills/bridgearc-agency/
              Sub-skills: [count]     Version: [version]

  TOOL SUITES
  ----------------------------------------------------------------
  [checkmark/x]  AI Marketing Suite      [count] skills   [version]
                 Path: .agents/skills/bridgearc-agency/
...
```
  ...
  AI Marketing Suite:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/ai-marketing-Antigravity/main/install.sh | bash

  AI Sales Team:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/ai-sales-Antigravity/main/install.sh | bash

  AI Legal Assistant:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/ai-legal-Antigravity/main/install.sh | bash

  AI Reputation Manager:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/ai-reputation-Antigravity/main/install.sh | bash

  GEO/SEO Audit Tool:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/geo-seo-Antigravity/main/install.sh | bash

  Install all missing suites at once:
    curl -sL https://raw.githubusercontent.com/zubair-trabzada/ai-agency-Antigravity/main/install-all.sh | bash
```
